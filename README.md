...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/autodynatrace-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12927&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/autodynatrace-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `autodynatrace` can be installed with:

```
conda install autodynatrace
```

It is possible to list all of the versions of `autodynatrace` available on your platform with:
